...
# new argument: handling additional argument for sorting itemsets (frequency)
def generate_iCount(file_path):
    iCount = {}
...
if __name__ == '__main__':
    ...
    # generates counter dictionary if an additional argument is provided
    if len(sys.argv) > 4:
        print('')
        print('With Optimization!')
        iCount = generate_iCount(sys.argv[4])
        ...
        for prefix in prefixDict:
            prefixDict[prefix] = sorted(prefixDict[prefix], key=iCount.get)
